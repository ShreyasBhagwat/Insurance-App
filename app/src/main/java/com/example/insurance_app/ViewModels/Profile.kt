...
import com.example.insurance_app.LoginActivity
...
class Profile : Fragment() {
    ...
    override fun onCreateView(
        ...
        logout=view.findViewById(R.id.logoutLL)
        logout.setOnClickListener{
            val sharedPreferencesLogin:SharedPreferences
            sharedPreferencesLogin=context!!.getSharedPreferences("login",
                AppCompatActivity.MODE_PRIVATE
            )
            sharedPreferencesLogin.edit().putBoolean("logged",false).apply();
